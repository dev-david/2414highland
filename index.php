				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 2414 Highland Ave? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 2414 Highland Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>2215 E 22nd St - Contiguous</strong></h3>
										<ul>
											<li>Contiguous with 2206 E 21st St</li>
											<li>5,460 Lot</li>
											<li>List: 1/9/08 - Pending: 2/4/08</li>
											<li>List: $99,000 - SOLD $75,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>2206 E 21st St - Contiguous</strong></h3>
										<ul>
											<li>Contiguous with 2215 E 22nd St</li>
											<li>5,460 Lot</li>
											<li>List: 1/9/08 - Pending: 2/4/08</li>
											<li>List: $99,000 - SOLD $75,000</li>
										</ul>
								...
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>1727 E 24th St</strong></h3>
										<ul>
											<li>0 Bed - 0 Bath</li>
											<li>7,000 Lot</li>
											<li>List: 8/8/12 - Pending: 9/10/12</li>
											<li>List: $99,000 - SOLD $99,000</li>
										</ul>
									</article>
								</div>
							</div>
